<template>
    <div class="coupon disable">
        <div class="tag">{{ coupon.type == 1 ? "满减券" : "折扣券" }}</div>
        <div class="left">
            <div class="jian" v-if="coupon.type == 1">￥{{ coupon.jian }}</div>
...
.coupon {
    ...
    height: 1.808rem;
    background: none;
    background-image: url("../assets/img/优惠券背景.png");
    ...
    .tag {
        ...
        border-radius: 0rem 0rem 0.056rem 0.056rem;
        font-size: 0.181rem;
        color: #2ecb62;
    ...
    &.disable {
        ...
        &:after {
            content: "";
            background: url("../assets/img/已过期.png");
            background-size: 100%;
            width: 1.017rem;
            height: 0.797rem;
            top: 0.15rem;
