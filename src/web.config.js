...
module.exports = {
    ...
    domain: process.env.NODE_ENV == 'development' ? 'http://192.168.2.173:8001/jcb-collect/api' : 'http://192.168.2.173:8001/jcb-collect/api', //测试服
    // domain: process.env.NODE_ENV == 'development' ? 'https://china-jcb.com/jcb-collect/api' : 'https://china-jcb.com/jcb-collect/api', //正式服
