...
export default new Router({
    routes: [{
        ...
        },
        {
            ...
            meta: { title: '进货优惠' },
            component: () =>
                import ('@/views/workbench/purchase-discount')
        },
        {
            ...
            meta: { title: '我的收藏' },
            component: () =>
                import ('@/views/workbench/collect')
        },
        {
        ...
        },
        {
            ...
            meta: { title: '管理地址' },
            component: () =>
                import ('@/views/workbench/address')
        },
        {
            ...
            meta: { title: '编辑地址' },
            component: () =>
                import ('@/views/workbench/address-edit')
        },
        {
            ...
            meta: { title: '店铺优惠券' },
            component: () =>
                import ('@/views/workbench/shop-coupons')
        },
        {
            ...
            meta: { title: '推广中心' },
            component: () =>
                import ('@/views/workbench/popularize')
        },
        {
            ...
            meta: { title: '推广人数' },
            component: () =>
                import ('@/views/workbench/popularize-people')
        },
        {
            ...
            meta: { title: '推广人订单' },
            component: () =>
                import ('@/views/workbench/popularize-order')
        },
        {
        ...
        },
        {
            ...
            meta: { title: '店铺交易订单详情' },
            component: () =>
                import ('@/views/workbench/shop-order')
        },
        {
            path: '/chooseCity',
            name: 'chooseCity',
            meta: { title: '选择城市' },
            component: () =>
                import ('@/views/purchase/choose-city')
        },
        {
            ...
            meta: { title: '品牌商品' },
            component: () =>
                import ('@/views/purchase/brand-zone')
        },
        {
        ...
        },
        {
            ...
            meta: { title: '大牌驾到' },
            component: () =>
                import ('@/views/purchase/brand-arrives')
        },
        {
            ...
            meta: { title: '特惠商品' },
            component: () =>
                import ('@/views/purchase/preferential')
        },
        {
        ...
        },
        {
            ...
            meta: { title: '选择收货地址' },
            component: () =>
                import ('@/views/order/choose-address')
        },
        {
            path: '/goods/detail',
            name: 'goods-detail',
        ...
        },
        {
            ...
            meta: { title: '选择配送地址' },
            component: () =>
                import ('@/views/goods/select-address')
        },
        {
            path: '/order',
            name: 'order',
        ...
        },
        {
            ...
            meta: { title: '退款申请' },
            component: () =>
                import ('@/views/order/refund/apply-refund')
        },
        {
            path: '/refund/all',
            name: 'moneyGoods',
